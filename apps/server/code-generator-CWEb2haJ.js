//#region src/lib/code-generator.ts
var CodeGenerationService = class {
	/**
	* Generate responsive React component based on prompt
	*/
	static async generateComponent(componentName, prompt, screenType = "generic") {
		const templates = {
	...
	*/
	static generateLoginComponent(name) {
...
export default ${name};`;
		return {
			...
			files: [{
				...
				content: "/* Component-specific styles if needed */"
			}]
		};
	}
	/**
	...
	*/
	static generateCounterComponent(name) {
		const code = `import React, { useState } from 'react';
...
export default ${name};`;
	...
	*/
	static generateTodoListComponent(name) {
...
export default ${name};`;
	...
	*/
	static generateDashboardComponent(name) {
		const code = `import React, { useState, useEffect } from 'react';
...
export default ${name};`;
	...
	*/
	static generateGenericComponent(name, prompt) {
		const code = `import React, { useState } from 'react';
